...
namespace HakeHR.Persistence.Infrastructure
{
    ...
    public static class SqlServerTransientExceptionDetector
    {
        ...
        /// <summary>
        /// Checks if sql exception that happened is transient and if it is worth retrying on
        /// </summary>
        ...
        /// <summary>
        /// Checks if win 32 exception that happened is transient and if it is worth retrying on
        /// </summary>
        /// <param name="ex">Win32 exception</param>
        /// <returns></returns>
